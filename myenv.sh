...
export EXROOT_INCLUDE_PATH=/afs/cern.ch/work/p/pablom/private/DelphesOlmo/delphes/external
export ROOT_INCLUDE_PATH=$EXROOT_INCLUDE_PATH:$ROOT_INCLUDE_PATH
export DELPHES_PATH=/afs/cern.ch/work/p/pablom/private/DelphesOlmo/delphes
